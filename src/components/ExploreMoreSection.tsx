...
const socialLinks = [
  {
    name: "YouTube",
    href: "https://www.youtube.com/@kpcodeventure",
    color: "group-hover:text-red-500",
    bgHover: "hover:border-red-500/50 hover:bg-red-500/10 hover:scale-105",
    icon: (
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/namratapatel9027/",
    color: "group-hover:text-[#0A66C2]",
    bgHover: "hover:border-[#0A66C2]/50 hover:bg-[#0A66C2]/10 hover:scale-105",
    icon: (
  ...
  {
    name: "GitHub",
    href: "https://github.com/Namratapatel9027",
    color: "group-hover:text-white",
    bgHover: "hover:border-white/50 hover:bg-white/10 hover:scale-105",
    icon: (
      <svg className="w-10 h-10" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
