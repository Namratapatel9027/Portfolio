...
export default function SplashCursor({
  ...
  useEffect(() => {
    ...
    // Fix the swap implementation to match double buffering properly
    const fixDoubleFBO = (fbo: DoubleFBO) => {
      fbo.swap = function() {
        const tmp = fbo.read;
        fbo.read = fbo.write;
        fbo.write = tmp;
    ...
    window.addEventListener('touchstart', handleTouchStartGlobal, false);
    ...
    window.addEventListener('touchmove', handleTouchMoveGlobal, false);
  ...
  return (
    <div
      style={{
        ...
        top: 0,
        left: 0,
        zIndex: 9999, // Set high to display above all content
        pointerEvents: 'none',
        width: '100%',
        height: '100%'
      }}
